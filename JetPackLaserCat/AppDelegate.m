...
//  JetPackLaserCat
//
//  Created by Noel Feliciano on 11-07-20.
...
- (void) applicationDidFinishLaunching:(UIApplication*)application
{
	...
	// Run the intro Scene
	[[CCDirector sharedDirector] runWithScene: [SplashPage scene]];                 //ALFJALKFJALKFA
}
...
-(void) applicationDidEnterBackground:(UIApplication*)application {
    ...
    [[GameVariables sharedGameVariables] saveLevelPacks];
